...
public class StreamingToRedis {
    public static void main(String[] args) throws Exception{
        ...
        DataStreamSource<String> text = env.socketTextStream("flink2", 9000, "\n");
        ...
        //创建redis的配置
        FlinkJedisPoolConfig conf = new FlinkJedisPoolConfig.Builder().setHost("flink1").setPort(6379).build();
