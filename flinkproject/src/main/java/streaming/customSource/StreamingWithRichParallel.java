...
public class StreamingWithRichParallel {
    public static void main(String[] args) throws Exception {

        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        DataStreamSource<Long> source = env.addSource(new RichParellel()).setParallelism(2);
        ...
        String name = StreamingWithRichParallel.class.getSimpleName();
        env.execute(name);
    }
}
